...
class RequestCrudController extends CrudController {
	public function setup() {
		...
		*/
		...
		$this->crud->addField([
			'label' => "Հայտի կանոնակարգը <b style='color:red'>հայերեն</b>",
			'name' => "condition",
			'type' => 'ckeditor',
		], 'update/create/both');

		$this->crud->addField([
			'label' => "Հայտի կանոնակարգը <b style='color:red'>անգլերեն</b>",
			'name' => "condition_eng",
			'type' => 'ckeditor',
		], 'update/create/both');

		$this->crud->addField([
			'label' => "Հայտի կանոնակարգը <b style='color:red'>ռուսերեն</b>",
			'name' => "condition_ru",
			'type' => 'ckeditor',
		], 'update/create/both');
		// ------ CRUD FIELDS
