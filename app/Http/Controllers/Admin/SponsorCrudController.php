...
class SponsorCrudController extends CrudController {
	public function setup() {
		...
		*/
		...
		// ------ CRUD FIELDS
		$this->crud->addField([
			'label' => "Հովանավորի անունը ,ու ինչ որ նկարագրություն",
			'name' => "title",
			'type' => 'ckeditor',
		], 'update/create/both');

		$this->crud->addField([
			'label' => "Հովանավորի անունը ,ու ինչ որ նկարագրություն <b style='color:red'>ռուսերենով</b>",
			'name' => "title_ru",
			'type' => 'ckeditor',
		], 'update/create/both');

		$this->crud->addField([
			'label' => "Հովանավորի անունը ,ու ինչ որ նկարագրություն <b style='color:red'>անգլերենով</b>",
			'name' => "title_eng",
			'type' => 'ckeditor',
		], 'update/create/both');

		$this->crud->addField([
			'label' => "Հովանավորի <b style='color:red'>լոգոն</b>  (կարող եք կտրել ըստ ցանկության)",
			'name' => "image",
			'type' => 'image',
			'prefix' => 'assets/',
			'upload' => true,
