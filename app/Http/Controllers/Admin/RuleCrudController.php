...
class RuleCrudController extends CrudController
{
    public function setup()
    {
        ...
        */
        ...
        $this->crud->addField([
            'label' => "Կանոնակարգի լրիվ տեքստը <b style='color:red'>հայերեն</b>",
            'name' => "text",
            'type' => 'ckeditor',
        ], 'update/create/both');

        $this->crud->addField([
            'label' => "Կանոնակարգի լրիվ տեքստը <b style='color:red'>անգլերեն</b>",
            'name' => "text_eng",
            'type' => 'ckeditor',
        ], 'update/create/both');

        $this->crud->addField([
            'label' => "Կանոնակարգի լրիվ տեքստը <b style='color:red'>ռուսերեն</b>",
            'name' => "text_ru",
            'type' => 'ckeditor',
        ], 'update/create/both');
